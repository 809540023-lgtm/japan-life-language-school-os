...
class SchoolPlatformApiTest(unittest.TestCase):
    ...
    def test_public_courses_and_dashboard(self) -> None:
        ...
        self.assertIn("AI 日語補習班營運平台 MVP", marketplace_response.text)
        ...
        self.assertIn("從學會日語", home_page_response.text)
        self.assertIn("找到你的專屬工作區", home_page_response.text)
        self.assertIn("Role Hubs", home_page_response.text)
