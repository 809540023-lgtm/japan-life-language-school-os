...
class SchoolPlatformSettings:
    ...
    material_url_allowlist_hosts: str = ""
    allow_default_seed_users: bool = False
...
def load_settings() -> SchoolPlatformSettings:
    return SchoolPlatformSettings(
        ...
        material_url_allowlist_hosts=os.getenv("SCHOOL_PLATFORM_MATERIAL_URL_ALLOWLIST_HOSTS", "").strip(),
        allow_default_seed_users=_as_bool(os.getenv("SCHOOL_PLATFORM_ALLOW_DEFAULT_USERS")),
        zoom_account_id=os.getenv("SCHOOL_PLATFORM_ZOOM_ACCOUNT_ID"),
        zoom_client_id=os.getenv("SCHOOL_PLATFORM_ZOOM_CLIENT_ID"),
        zoom_client_secret=os.getenv("SCHOOL_PLATFORM_ZOOM_CLIENT_SECRET"),
        zoom_user_id=os.getenv("SCHOOL_PLATFORM_ZOOM_USER_ID"),
        zoom_api_base_url=os.getenv("SCHOOL_PLATFORM_ZOOM_API_BASE_URL", "https://api.zoom.us/v2").rstrip("/"),
        zoom_oauth_base_url=os.getenv("SCHOOL_PLATFORM_ZOOM_OAUTH_BASE_URL", "https://zoom.us").rstrip("/"),
        zoom_timezone=os.getenv("SCHOOL_PLATFORM_ZOOM_TIMEZONE", "Asia/Tokyo").strip() or "Asia/Tokyo",
        ...
        line_channel_access_token=os.getenv(
            "SCHOOL_PLATFORM_LINE_CHANNEL_ACCESS_TOKEN",
            os.getenv("LINE_CHANNEL_ACCESS_TOKEN"),
        ),
        line_channel_secret=os.getenv("SCHOOL_PLATFORM_LINE_CHANNEL_SECRET", os.getenv("LINE_CHANNEL_SECRET")),
        line_fallback_user_id=_first_present_env(
            "SCHOOL_PLATFORM_LINE_FALLBACK_USER_ID",
            "LINE_FALLBACK_USER_ID",
            "LINE_CHANNEL_FALLBACK_USER_ID",
        ),
        ...
        notification_test_line_user_id=_first_present_env(
            "SCHOOL_PLATFORM_NOTIFICATION_TEST_LINE_USER_ID",
            "SCHOOL_PLATFORM_LINE_FALLBACK_USER_ID",
            "LINE_FALLBACK_USER_ID",
            "LINE_CHANNEL_FALLBACK_USER_ID",
        ),
